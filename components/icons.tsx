...
export function RightArrow(props: React.PropsWithChildren<{
    ...
    return (
        <>
            <div className={Styles.container}>
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m321-80-71-71 329-329-329-329 71-71 400 400L321-80Z" fill={colour}/></svg>
            </div>
        </>
    );
}
...
export function LeftArrow(props: React.PropsWithChildren<{
    ...
    return <></> // TODO: make this the right size
    return (
        <>
            <div className={Styles.container}>
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M400-80 0-480l400-400 71 71-329 329 329 329-71 71Z" fill={colour}/></svg>
            </div>
        </>
    );
}
